...
<body>
  ...
  <div class="container">
    <div class="row mt presentation">
      <h1 class="centered">CEK & DOWNLOAD</h1>
      <hr>
    </div>
  </div>
  <div class="container">
    <h2>CEK NILAI & DOWNLOAD MATERI 3IA18</h2>
    <hr>
    <div class="table-responsive">
      <table class="table table-hover table-bordered table-striped" id="datatables">
        ...
        <tbody>
          <tr>
            <td>NILAI</td>
            <td> <button type="button" name="button" class="button"> <a href="downloadkelas.php"> LIHAT </a> </button> </td>
          </tr>
          <tr>
            <td>MATERI LAB</td>
